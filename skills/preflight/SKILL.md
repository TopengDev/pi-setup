...
2. **Root cause analysis first** — read the relevant source code, understand WHY the error exists, not just what the symptom is
3. Fix the root cause immediately — edit the code directly
